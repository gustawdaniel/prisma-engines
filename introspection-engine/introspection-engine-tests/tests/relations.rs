...
#[test_each_connector]
async fn one_to_one_req_relation(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            move |migration| {
...
#[test_each_connector]
async fn one_to_one_relation_on_a_singular_primary_key(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            |migration| {
                migration.create_table("User", |t| {
...
#[test_each_connector]
async fn two_one_to_one_relations_between_the_same_models(api: &TestApi) {
...
#[test_each_connector]
async fn a_one_to_one_relation(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            |migration| {
                migration.create_table("User", |t| {
...
#[test_each_connector]
async fn a_one_to_one_relation_referencing_non_id(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            |migration| {
                migration.create_table("User", |t| {
...
#[test_each_connector]
async fn a_one_to_many_relation(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            |migration| {
                migration.create_table("User", |t| {
...
#[test_each_connector]
async fn a_one_req_to_many_relation(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            |migration| {
                migration.create_table("User", |t| {
...
#[test_each_connector]
async fn a_prisma_many_to_many_relation(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            |migration| {
                migration.create_table("User", |t| {
...
#[test_each_connector]
async fn a_many_to_many_relation_with_an_id(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            |migration| {
                migration.create_table("User", |t| {
...
#[test_each_connector]
async fn a_self_relation(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            move |migration| {
                migration.create_table("User", move |t| {
...
async fn id_fields_with_foreign_key(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            move |migration| {
                migration.create_table("User", |t| {
...
#[test_each_connector(ignore("sqlite"))]
async fn duplicate_fks_should_ignore_one_of_them(api: &TestApi) {
    api.barrel()
        .execute_with_schema(
            |migration| {
                migration.create_table("User", |t| {
...
async fn default_values_on_relations(api: &TestApi) {
    api.barrel()
        .execute(|migration| {
            migration.create_table("User", |t| {
                t.add_column("id", types::primary());
...
#[test_each_connector]
async fn prisma_1_0_relations(api: &TestApi) {
    api.barrel()
        .execute(|migration| {
...
#[test_each_connector]
async fn relations_should_avoid_name_clashes(api: &TestApi) {
    api.barrel()
        .execute(|migration| {
...
#[test_each_connector(ignore("mssql_2017", "mssql_2019"))]
async fn relations_should_avoid_name_clashes_2(api: &TestApi) {
    let sql_family = api.sql_family();
    ...
    api.barrel()
        .execute(move |migration| {
            ...
            migration.create_table("y", move |t| {
                ...
                if sql_family.is_sqlite() {
                    t.add_foreign_key(&["fk_x_1", "fk_x_2"], "x", &["y", "id"]);
                }
            });
